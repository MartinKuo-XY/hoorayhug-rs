...
pub struct SockAddrStore {
    ...
    inner: hoorayhug_io::mmsg::SockAddrStore,
...
impl SockAddrStore {
    pub const fn new() -> Self {
        Self {
            #[cfg(all(target_os = "linux", feature = "batched-udp"))]
            inner: hoorayhug_io::mmsg::SockAddrStore::new(),
...
mod linux {
    ...
    use hoorayhug_io::mmsg::{MmsgHdr, MmsgHdrMut};
    use hoorayhug_io::mmsg::{send_mul_pkts, recv_mul_pkts};
