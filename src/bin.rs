...
use hoorayhug::cmd;
use hoorayhug::conf::{Config, FullConf, LogConf, DnsConf, EndpointInfo};
use hoorayhug::ENV_CONFIG;
...
fn setup_dns(dns: DnsConf) {
    ...
    hoorayhug::core::dns::build_lazy(conf, opts);
}

fn setup_transport() {
    #[cfg(feature = "transport")]
    {
        hoorayhug::core::kaminari::install_tls_provider();
    }
}
...
async fn run(endpoints: Vec<EndpointInfo>) {
    use hoorayhug::core::tcp::run_tcp;
    use hoorayhug::core::udp::run_udp;
