...
mod tests {
    ...
    fn ih_any_hash() {
        ...
        run!(b"hoorayhug", 885396906);
        run!(b"1 hoorayhug", 4115282535);
        run!(b"2 hoorayhug", 1326782105);
        run!(b"3 hoorayhug", 1796078392);
        run!(b"10 hoorayhug", 2265248424);
        run!(b"100 hoorayhug", 4289654351);
    }
